...
# SNPs_input <- "/oasis/tscc/scratch/mioverto/LOH_methods/Sui_etal/variants/reconciled/L_W303xYJM789_reconciled_SNPs.RData"
# model_input <- "/oasis/tscc/scratch/mioverto/LOH_methods/Sui_etal/variants/reconciled/L_W303xYJM789_hetTrain.RData"
# model_type <- "v"
# FE_rate <- 0.05
# SNPs_output <- "/oasis/tscc/scratch/mioverto/LOH_methods/Sui_etal/variants/reconciled/L_W303xYJM789_hetFilter_SNPs.RData"
...
varAlt_sumDP <- model_list[[1]]
model_table <- model_list$summary_table
